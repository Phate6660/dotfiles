...
# :)
e-shrooms() {
	P=( " " █ ░ ▒ ▓ ); while :; do printf "\e[$[RANDOM%LINES+1];$[RANDOM%COLUMNS+1]f${P[$RANDOM%5]}"; done | lolcat
}
...
alias e="emacs -nw"
alias glog="git log --graph --pretty=\"%Cred%h%Creset -%C(auto)%d%Creset %s %Cgreen(%cr) %C(bold blue)<%an>%Creset\" --stat" # Thanks ncdulo.
...
alias cp="xcp -vw 5" # interactive and verbose
